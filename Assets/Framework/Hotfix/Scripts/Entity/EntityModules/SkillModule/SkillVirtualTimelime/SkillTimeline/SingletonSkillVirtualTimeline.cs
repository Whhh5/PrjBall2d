internal class SingletonSkillVirtualTimeline : SkillVirtualTimeline
{
    ...
    //        return;
    //    var runData = playableData.customData as SkillTypeLinkPlayableAdapterCustomData;
    //    m_RunAnimList = runData.arrParams.Copy();
    //    m_CurClipAdapter = _Graph.CreateClipPlayableAdapter(m_RunAnimList[0]);
